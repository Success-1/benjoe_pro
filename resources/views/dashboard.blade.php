							...
							<ul>
								...
								<li>
									<div class="header-icons">
										...
										<a class="mobile-hide" href="/login"><form method="POST" action="{{ route('logout') }}">
                                            @csrf
                                            <button type="submit" style="background: white; padding: 2px 10px; color: green; border:none; border-radius: 16px;">Logout</button>
                                        </form></a>
									</div>
								</li>
							</ul>
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-12">
						<div class="abt-text">
							...
							<a href="/home" class="boxed-btn mt-4" id="services">know more</a>
						</div>
					</div>
				</div>
			</div>
